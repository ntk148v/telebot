...
from telebot.helpers.aiohttp import AioHttp
from telebot.plugins.help import add_command_help


@Telebot.on_message(filters.command("corona", Config.COMMAND_HANDLER))
...
@Telebot.on_message(filters.command("coronabycountry", Config.COMMAND_HANDLER))
...
add_command_help(
    "corona",
    [
        [f"{Config.COMMAND_HANDLER}corona",
            "Sends global corona stats: cases, deaths, recovered, and active cases"],
        [
            f"{Config.COMMAND_HANDLER}coronabycountry Country",
